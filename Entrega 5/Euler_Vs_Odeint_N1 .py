...
plt.subplot(3,1,1)
plt.title("Euler Vs Odeint -- 1 subdivision ", fontweight = 'bold') 
...
plt.xticks( x_H, x_H_text, rotation = 90 )
plt.yticks( y_Km, y_Km_text)
plt.savefig('Posicion Euler Vs Odeint-- 1 subdivision' ,dpi = 300)
plt.show()
...
titulo = 'Euler_Vs_Odeint -- 1 subdivision, D_max =', D_max, 'Km'
plt.title( titulo , fontweight = 'bold') 
plt.ylabel ('Deriva (KM)' , fontweight = 'bold')
plt.xlabel ('T iempo, t (Horas)',  fontweight = 'bold' )
plt.xticks( x_H, x_H_text, rotation = 90 )
plt.savefig('Distancia Euler Vs Odeint-- 1 subdivision' ,dpi = 300)
plt.show()
