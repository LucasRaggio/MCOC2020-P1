...
def satelite(z , t):
    ...
    if correccion == 3: 
        zp[3] =  z2p[0] + FJ3_convert[0]
        zp[4] =  z2p[1] + FJ3_convert[1]
        zp[5] =  z2p[2] + FJ3_convert[2]      
...
plt.subplot(3,1,1)
plt.title("Posición (J2 y J3)", fontweight = 'bold') 
...
plt.plot(t,r_real_simulado/1000 )

titulo = 'J3 Distancia entre posición real y predicha, D_max =', D_max, 'Km'
plt.title( titulo , fontweight = 'bold') 
plt.ylabel ('Deriva (KM)' , fontweight = 'bold')
plt.xlabel ('T iempo, t (Horas)',  fontweight = 'bold' )
plt.xticks( x_H, x_H_text, rotation = 90 )
#plt.savefig('Dis J3 sol' ,dpi = 300)
plt.show()
...
# titulo = 'Euler, D_max =', D_max, 'Km'
# plt.title( titulo , fontweight = 'bold') 
# plt.ylabel ('Deriva (KM)' , fontweight = 'bold')
# plt.xlabel ('T iempo, t (Horas)',  fontweight = 'bold' )
# plt.xticks( x_H, x_H_text, rotation = 90 )
# #plt.savefig('NADA 3' ,dpi = 300)
# plt.show()
